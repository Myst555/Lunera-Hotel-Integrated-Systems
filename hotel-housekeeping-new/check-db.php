<?php
$conn = new mysqli('localhost', 'root', 'vince@21');
...
// Check tasks table
$dbCheck1 = @new mysqli('localhost', 'root', 'vince@21', 'roomslunera_hotel');
...
$dbCheck2 = @new mysqli('localhost', 'root', 'vince@21', 'roomslunera_Hotel');
